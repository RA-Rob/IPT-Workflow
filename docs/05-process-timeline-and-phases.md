...
This is the step-by-step process a Red Alpha IPT follows to take **intellectual property Red Alpha has the right to reuse**, demonstrated to a customer, to a shipped, operating, licensable product — by way of a **customer-funded MVP** tailored to that customer's mission. It is organized as **five phases separated by five gates**. A *phase* is a period of work with a clear purpose; a *gate* is a short, explicit decision point where the accountable parties decide whether to continue, adjust, or stop. Gates are what keep a lean team honest — they are the cheap moments to change course. The numbering is deliberate and worth memorizing: **Gate 0 opens the work, and after that Gate N closes Phase N.**

Two things about this process are easy to miss and matter more than anything else in it:

**What we shop and what we build are different stages, paid for by different people.** What we shop is capability and lessons learned derived from work an earlier customer already funded, generalized beyond that mission, and confirmed by RA Legal as Red Alpha's to use — which these documents call **cleared IP** for short, meaning *legally* cleared and not security-cleared (document 01). It is usually packaged as a working demonstration. The MVP is the *new* customer's investment, spent tailoring our core product to their environment and their mission. Both take real time and both are necessary — the demonstrated capability is what establishes that it applies to this customer's mission, and the MVP is the work of making it actually fit. Treating them as one thing is how teams end up asking a customer to fund something they have never seen working, or demoing a proof of concept as though it were a finished product. The full contrast is tabulated in [`07-glossary-and-references.md`](07-glossary-and-references.md).
...
Throughout, the process follows the two disciplines from document 03: **reduce uncertainty cheaply before committing, then let the team own delivery in fixed-time cycles.** Security is not a phase; it runs across all of them (document 06).
...
**Purpose.** Adapt a capability that already works into *this* customer's **mission space** — their organization, their requirements, their data, their integrations, their workflows — and get it into their operators' hands incrementally, so the adaptation is steered by use rather than guessed at.

**Be precise about what is and is not in question here.** Whether the capability applies to this mission was settled before Gate 0: that is what the demonstration established and what the customer committed funding on the strength of. This phase does not re-litigate it. What is genuinely open is **what it takes to make the capability fit** — a mission space we have not worked in before will differ from the originating one in ways neither side can fully enumerate up front, and the cheapest way to find those differences is to put working software in front of the people who do the work and watch where it does not match how they operate. The cycles exist to steer the tailoring, not to validate the premise. This is the phase the customer is funding, and its defining property is that they see working capability repeatedly rather than once.
