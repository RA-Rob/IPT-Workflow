...
└── plans/                # Captured IDE plan-mode plans (transcript-attributed)
```
...
### Plan Articles (`knowledge/plans/`)

Captured IDE plan-mode plans (e.g. Cursor plans). A plan is attributed to this
project only because the project's own session transcript referenced it, so
plans from other projects never leak in. Compiled from `### Plan: ...` sections
in the daily log.

```markdown
---
title: "Plan: Plan Name"
status: in-progress   # or: completed (all todos done)
sources:
  - "daily/2026-07-16.md"
created: 2026-07-16
updated: 2026-07-16
...
## Overview
[One-paragraph summary of the plan's goal]
...
## Detail
[The durable decisions and approach from the plan]

## Related Concepts
- [[concepts/relevant-article]]
```
